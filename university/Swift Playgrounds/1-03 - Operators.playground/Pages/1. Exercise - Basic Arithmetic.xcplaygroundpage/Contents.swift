...
print("I think the value will be rounded down to 3")
...
print("The value is not rounded down, because it allowes floating point numbers")
/*:
...
let even = 2 % 2
let odd = 1 % 2
print("if the reminder is one the number is odd if its 0 its even")
/*:
