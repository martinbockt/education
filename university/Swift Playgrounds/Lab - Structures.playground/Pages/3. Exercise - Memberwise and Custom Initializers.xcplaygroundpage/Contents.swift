...
let favoriteBook = Book(title: "Elon Musk: Wie Elon Musk die Welt verändert", author: "Ashlee Vance", pages: 400, price: 19.99)
print("My favorite book is called \(favoriteBook.title), written by \(favoriteBook.author). It has \(favoriteBook.pages) pages and costs \(favoriteBook.price) Euro")
/*:
...
var myHeight = Height(heightInCentimeters: 181)
print(myHeight)
/*:
