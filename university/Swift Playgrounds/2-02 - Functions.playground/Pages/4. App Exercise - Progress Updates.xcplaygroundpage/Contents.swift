 ...
 */
func progressUpdate(_ steps: Int, goal: Int) {
    if steps < goal / 10 {
...
var i = 0
while i < 1000 {
    progressUpdate(i, goal: 1000)
    print("steps " + String(i))
    i += 100
}
...
print(pacing(20,totalDistance: 2000,currentTime: 200,goalTime: 2000))
