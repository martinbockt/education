...
if let firstWorkout = Workout(startTime: 35, endTime: 50) {
    print(firstWorkout.startTime)
}
if let secondWorkout = Workout(startTime: 45, endTime: 50) {
    print(secondWorkout.startTime)
}
