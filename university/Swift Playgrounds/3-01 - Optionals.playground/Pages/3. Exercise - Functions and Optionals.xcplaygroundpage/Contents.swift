...
func checkAge (_ input: String) -> Int? {
    
    if let check = Int(input) {
...
// the function will return nil or no valiue if anything in the argument string was passed
