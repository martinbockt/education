...
print("I worte it that way, because the text excluded the number 5.000 (half of the stepGoal) If I want to include it, I would need to add an additional else if, furthermore an extra condition to the else if and an additional else would be usefull for \"You passed your stepGoal\"")
...
print("again stepGoal/2 is excluded by the text")
/*:
