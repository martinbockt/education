...
let currentHR = 128
switch currentHR {
    case Int.min...99: print("Get more active to get in the next heartrate zone.")
    case ...120: print("You are in the Very Light zone. Activity in this zone helps with recovery.")
case ..>140: print("You are in the Light zone. Activity in this zone helps improve basice endurance and fat burning.")
    ...
    default: print("Warning: Your heartrate is too high, slow down!")
}
/*:
