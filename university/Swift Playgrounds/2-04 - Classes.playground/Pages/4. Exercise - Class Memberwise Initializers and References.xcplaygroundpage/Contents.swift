 ...
 */
let destroyer = Fighter(name: "Destroyer", health: 90, position: 4, weapon: "Laser", remainingFirePower: 20)
 ...
 */
let defender = ShieldedShip(name: "Defender", health: 120, position: -5, weapon: "Canon", remainingFirePower: 10, shieldStrength: 25)
...
// The adress of the variables from sameShip is the same as falcon
/*:
