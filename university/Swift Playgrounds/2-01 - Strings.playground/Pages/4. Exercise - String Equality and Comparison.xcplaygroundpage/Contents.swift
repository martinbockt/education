 ...
 */
if nameInCops.lowercased() == name.lowercased() {
    print("\(nameInCops.lowercased()) and \(nameInCops.lowercased()) are the same.")
} else {
    print("\(nameInCops.lowercased()) and \(nameInCops.lowercased()) are not the same.")
}
