...
let shapesArray: [String] = ["circle", "triangle"]
let colorsArray: [String] = ["blue", "red"]
var shapesColors: [String: [String]] = ["shapes": shapesArray, "colors": colorsArray]
print(shapesColors)
...
if let color = shapesColors["colors"] {
    print(color.last!)
}
/*:
