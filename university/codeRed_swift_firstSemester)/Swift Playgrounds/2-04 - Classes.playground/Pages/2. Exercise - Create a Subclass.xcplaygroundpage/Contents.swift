...
//print(falcon.weapon) won't work, because falcon is not defined. But the falcon from Page 1 is not an instance of Fighter, therefore falcon can only acess the properties of the class Spaceship and not the subclass Fighter.
