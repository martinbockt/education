...
var martin = User(name: "Martin Bock", age: 21, height: 181, weight: 89, activityLevel: 4)
print("\(martin.name) is \(martin.age) years old. He is \(martin.height)cm tall and weighs \(martin.weight)kg. His activity level is \(martin.activityLevel).")
/*:
